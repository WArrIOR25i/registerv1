        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-lg text-gray-300 mb-6">
              ...
              global broadcasting, Nexus Tournament offers an immersive
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-black/50 backdrop-blur-sm border border-purple-500/30 rounded-lg p-6 hover:border-purple-500/60 transition-colors">
              ...
              <h3 className="text-xl font-bold mb-2">$250,000 Prize Pool</h3>
              <p className="text-gray-400">
                Compete for life-changing prizes across multiple game titles
              </p>
            </div>
            ...
            <div className="bg-black/50 backdrop-blur-sm border border-purple-500/30 rounded-lg p-6 hover:border-purple-500/60 transition-colors">
              ...
              <p className="text-gray-400">
                Top teams from around the world competing for supremacy
              </p>
            </div>
            ...
            <div className="bg-black/50 backdrop-blur-sm border border-purple-500/30 rounded-lg p-6 hover:border-purple-500/60 transition-colors">
              ...
              <p className="text-gray-400">
                Streamed live to millions of viewers worldwide
              </p>
            </div>
          </div>
        </div>
